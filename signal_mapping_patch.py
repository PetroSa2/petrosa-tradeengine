#!/usr/bin/env python3
"""
Signal mapping patch to apply directly to running container
"""
...
if old_line in content:
    ...
    print("❌ Could not find signal creation line")
...
# Find the end of the SignalConsumer class and add the mapping function
...
print("✅ Created patched consumer.py file: tradeengine/consumer_patched.py")
